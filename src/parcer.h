 ...
 *  ТОЧКИ
 *  -----
 *  Парсим в массив vertices вида {0, X1, Y1, Z1, X2, ... Zn}
 *
 *  !!!ВАЖНО!!!
 *  ПЕРВЫЙ ЭЛЕМЕНТ МАССИВА НУЛЕВОЙ!
 *  Таким образом приходим к классической индексации с первого элемента
 *  (не с нулевого)
 *
 *  ПРИМЕР:
 *
 ...
 *  v 6 -5 2
 *
 *  vertces = {3.76, 9.17, -67.1, 35.10, 2.01, 8.345, 6, -5, 2}
 *
 */
