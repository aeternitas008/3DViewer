...
START_TEST(s21_rotate_X) {
  ...
  double array[] = {0.0,  0.0,       0.0,       1.0,  -1.083350, -0.909038,
                    1.0,  -0.909038, 1.083350,  -1.0, -0.909038, 1.083350,
                    -1.0, -1.083350, -0.909038, 1.0,  0.909038,  -1.083350,
                    1.0,  1.083350,  0.909038,  -1.0, 1.083350,  0.909038,
...
START_TEST(s21_rotate_Y) {
  ...
  double array[] = {0.0,       0.0,  0.0,       1.083350,  -1.0, -0.909038,
                    0.909038,  -1.0, 1.083350,  -1.083350, -1.0, 0.909038,
                    -0.909038, -1.0, -1.083350, 1.083350,  1.0,  -0.909038,
                    0.909038,  1.0,  1.083350,  -1.083350, 1.0,  0.909038,
...
START_TEST(s21_rotate_Z) {
  ...
  double array[] = {0.0,       0.0,       0.0,  0.909038,  -1.083350, -1.0,
                    0.909038,  -1.083350, 1.0,  -1.083350, -0.909038, 1.0,
                    -1.083350, -0.909038, -1.0, 1.083350,  0.909038,  -1.0,
                    1.083350,  0.909038,  1.0,  -0.909038, 1.083350,  1.0,
...
START_TEST(s21_rotate_X_back) {
  ...
  double array[] = {0.0,  0.0,       0.0,       1.0,  -0.909038, -1.083350,
                    1.0,  -1.083350, 0.909038,  -1.0, -1.083350, 0.909038,
                    -1.0, -0.909038, -1.083350, 1.0,  1.083350,  -0.909038,
                    1.0,  0.909038,  1.083350,  -1.0, 0.909038,  1.083350,
...
START_TEST(s21_rotate_Y_back) {
  ...
  double array[] = {0.0,       0.0,  0.0,       0.909038,  -1.0, -1.083350,
                    1.083350,  -1.0, 0.909038,  -0.909038, -1.0, 1.083350,
                    -1.083350, -1.0, -0.909038, 0.909038,  1.0,  -1.083350,
                    1.083350,  1.0,  0.909038,  -0.909038, 1.0,  1.083350,
...
START_TEST(s21_rotate_Z_back) {
  ...
  double array[] = {0.0,       0.0,       0.0,  1.083350,  -0.909038, -1.0,
                    1.083350,  -0.909038, 1.0,  -0.909038, -1.083350, 1.0,
                    -0.909038, -1.083350, -1.0, 0.909038,  1.083350,  -1.0,
                    0.909038,  1.083350,  1.0,  -1.083350, 0.909038,  1.0,
