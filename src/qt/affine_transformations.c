 ...
 * @brief This file contains functions and classes for performing affine
 * transformations in 2D/3D space.
 *
 * The affine transformations include translation, rotation, scaling, and
 * shearing operations that can be applied to points, vectors, and objects. The
 * functions are designed to work with matrices and provide utilities for
